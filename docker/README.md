...
official/supported Docker Images found at https://hub.docker.com/r/kawrispay/kawrisd/
...
**NOTE: Please update the image description at https://hub.docker.com/r/kawrispay/kawrisd-develop/ when changing the above text**