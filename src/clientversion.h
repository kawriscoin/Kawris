...
//! These need to be macros, as clientversion.cpp's and kawris*-res.rc's voodoo requires it
...
/**
 * kawrisd-res.rc includes this file, but it cannot cope with real c++ code.
