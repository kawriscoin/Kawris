...
#define BOOST_TEST_MODULE Kawris Test Suite

#include "test_kawris.h"
...
TestingSetup::TestingSetup(const std::string& chainName) : BasicTestingSetup(chainName)
{
    const CChainParams& chainparams = Params();
        ...
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_kawris_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
