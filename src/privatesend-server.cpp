...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, const std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if (fLiteMode) return; // ignore all Kawris related functionality
...
/*
    ...
    allow endless transaction that would bloat Kawris and make it unusable. To
...
{
    if (fLiteMode) return;        // disable all Kawris specific functionality
