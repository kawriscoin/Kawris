...
void masternode_list_help()
{
    throw std::runtime_error(
            ...
            "  owneraddress   - Print the masternode owner Kawris address\n"
            "  payee          - Print the masternode payout Kawris address (can be additionally filtered,\n"
            "                   partial match)\n"
            "  pubKeyOperator - Print the masternode operator public key\n"
            "  status         - Print masternode status: ENABLED / POSE_BANNED\n"
            "                   (can be additionally filtered, partial match)\n"
            "  votingaddress  - Print the masternode voting Kawris address\n"
        );
}
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "kawris",               "masternode",             &masternode,             true,  {} },
    { "kawris",               "masternodelist",         &masternodelist,         true,  {} },
    { "kawris",               "getpoolinfo",            &getpoolinfo,            true,  {} },
#ifdef ENABLE_WALLET
    { "kawris",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
