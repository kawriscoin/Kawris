...
This document provides guidelines for internationalization of the Kawris Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `kawris_en.ts` remains unchanged.
