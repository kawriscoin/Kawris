...
* kawris.conf: contains configuration settings for kawrisd or kawris-qt
* kawrisd.pid: stores the process id of kawrisd while running
* database/*: BDB database environment; only used for wallet
* db.log: wallet database log file
* debug.log: contains debug information and general logging generated by kawrisd or kawris-qt
