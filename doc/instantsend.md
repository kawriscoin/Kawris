...
This mechanism has been integrated into Bitcore-Node-Kawris which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/kawrispay/insight-api-kawris#web-socket-api](https://github.com/kawrispay/insight-api-kawris#web-socket-api)
* API: [https://github.com/kawrispay/insight-api-kawris#instantsend-transactions](https://github.com/kawrispay/insight-api-kawris#instantsend-transactions)
