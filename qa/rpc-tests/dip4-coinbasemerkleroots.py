...
from test_framework.test_framework import KawrisTestFramework
...
class LLMQCoinbaseCommitmentsTest(KawrisTestFramework):
    def __init__(self):
    ...
    def run_test(self):
        ...
        # Register one more MN, but don't start it (that would fail as KawrisTestFramework doesn't support this atm)
