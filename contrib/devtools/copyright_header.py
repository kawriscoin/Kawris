...
Arguments:
    <base_directory> - The base directory of a Kawris Core source code repository.
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The Kawris Core developers'
...
Arguments:
    <base_directory> - The base directory of Kawris Core source code repository.
"""
...
Arguments:
    <file> - A source file in the Kawris Core repository.
"""
